...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row
      .col-md-12
        p En el siguiente video se puede observar el proceso de instalación de 
          em Windows Server 
          | 2016, es importante prestar mucha atención a todos los procedimientos y explicaciones que se detallan allí:

    figure.mb-5
    .video.mb-5
      iframe(width="560" height="315" src="https://www.youtube.com/embed/PCGtRimK1Kc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
    ...
    .tarjeta--container.row.mb-5
      .col-md.tarjeta.color-secundario.p-5
        ...
        p El usuario realiza el procedimiento paso a paso utilizando el 
          em software 
    ...
    h3
      ...
      em PowerShell
    p.mb-4 Para la configuración desde el 
      em PowerShell, 
